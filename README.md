...
The SQL queries used to inspect and clean the data can be found here → [`sql/01_data_review.sql`](sql/01_data_review.sql) and [`sql/02_cleaning.sql`](sql/02_cleaning.sql)
